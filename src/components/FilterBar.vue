		...
		<div class="mt-4 flex flex-col">
			<div class="flex mb-4 gap-4">
				<div class="flex items-center">
					Newest first
					<ToggleSwitch v-model="newest" class="ml-4" />
				</div>
				<div class="flex items-center">
					Month's reading
					<ToggleSwitch v-model="monthReading" class="ml-4" />
				</div>
			</div>
			<span class="flex flex-wrap lg:flex-nowrap gap-4"
				...
				<MultiSelect
					...
					class="w-full lg:w-6/12 mb-4" /></span
			>
			<span class="flex flex-wrap lg:flex-nowrap gap-4">
				<MultiSelect
			...
			<div class="flex flex-wrap w-full lg:w-6/12 mb-4">
				<span
					...
					<label for="item" class="ml-1"
						>{{ item[locale as keyof LocaleName] }}</label
					>
				</span>
			</div>
		</div>
