		...
		<TabPanels>
			<TabPanel value="addbook">
				<div v-if="metadata" id="newbookform">
					...
					<img v-if="imgPreview" class="object-contain h-96" :src="imgPreview">
	...
	<Dialog
		...
		<div class="flex justify-end gap-2">
			<Button
				...
				label="Cancel"
				severity="secondary"
				@click="seriesVisible = false"></Button>
			<Button
				type="button"
				label="Save"
				:disabled="loading"
				@click="submitSeries"></Button>
		</div>
	</Dialog>
	<Dialog
		...
		<div class="flex justify-end gap-2">
			<Button
				...
				label="Cancel"
				severity="secondary"
				@click="authorVisible = false"></Button>
